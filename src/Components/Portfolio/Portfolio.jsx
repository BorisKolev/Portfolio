    ...
    <section id='portfolio'>
        ...
        <div className="container portfolio__container">
              ...
              <article className="portfolio__item">
                ...
                <h3>
                  Percy is a web application used for creating purchase orders, 
                  I have been working in variety of pages, backend services, 
                  databases to improve software and user experience.
                  <br></br><br></br>
                  Tech: C#/.NET, TS/React.
                </h3>
            </article>
            ...
            <article className="portfolio__item">
                ...
                <h3>
                Maggie is a web application used for replenishing / recalling goods, in / out of a warehouse, 
                I have been working in variety of pages, backend services, 
                databases to improve software and user experience.
                <br></br><br></br>
                Tech: TS/React.
            ...
            <article className="portfolio__item">
                <div className="portfolio__item-image">
                  <img src={ProgrammingViewerIMG} alt="Programming viewer desktop app"></img>
                </div>
                <h3>
                  Programming Viewer is standalone application used internally within ASM Assembly Systems
                  for reading files with information about the current programs ran on the machine before it crashes.
                  <br></br><br></br>
            ...
            <article className="portfolio__item">
                ...
                <h3>
                  ...
                  Supporting multiple features: <br></br> variable assignments, math operations, function calls, error handling and so on.
                  <br></br><br></br>
                  Tech: Java/Antrl.
                </h3>
            ...
            <article className="portfolio__item">
                ...
                <h3>
                  Finding the solution to a small puzzle using AI Breadth First Search.
                  <br></br><br></br>
                  Tech: Java.
                </h3>
            ...
            <article className="portfolio__item">
                ...
                <h3>
                  Logistic Regression classifier used to predict negative or positive reviews using TF-IDF vectorization.
                  <br></br><br></br>
