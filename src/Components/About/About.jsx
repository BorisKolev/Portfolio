    ...
    <section id='about'>
      ...
      <div className="container about__container">
        ...
        <div className='about__content'>
          ...
          <p>
            Full stack engineer at Coolblue (Netherlands, Utrecht) and graduated with 
            Computer Science BSc (Hons) (1st) including Placement Year degree at the University of Essex, UK. <br></br><br></br>
